...
import ClassificationCards from '@/views/App/ClassificationCard/ClassificationCards.vue';
import AddOrUpdateClassificationCard from '@/views/App/ClassificationCard/AddOrUpdateClassificationCard.vue';
