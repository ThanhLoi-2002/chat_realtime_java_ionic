    ...
    <div v-else class="h-full">
        ...
        <div class="pt-10 pb-4 px-2 dark:bg-gray-800 overflow-auto h-[75%]">
            ...
            <div class="flex gap-3 mt-2">
                <button class="flex-1 border hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-slate-600 dark:border-slate-700 dark:text-slate-300 py-2 rounded cursor-pointer">
                    Kết bạn
                </button>
