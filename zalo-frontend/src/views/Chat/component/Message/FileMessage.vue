<template>
    <div ref="el" :class="[
        ...
        'px-2 py-2',
        isOwner && message.stt === -1 ? 'bg-blue-900 text-white' : 'bg-white dark:bg-gray-800 dark:text-slate-100',
        ...
        <div :class="[
            ...
            <div v-else v-for="(file, index) in getDocuments(message.attachments)" :key="'doc-' + index"
