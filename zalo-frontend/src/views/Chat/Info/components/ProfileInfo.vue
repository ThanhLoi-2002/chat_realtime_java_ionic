            ...
            <div v-if="currentView == 'info'">
                ...
                <div :class="['py-4 border-b overflow-y-auto', style.border.primary]">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <group-avatar :conversation="conversationStorage.conversation!" size="w-20 h-20" v-else />
                   ...
                   cursor-pointer transition" @click="openFile">
                                <div
                                    class="w-10 h-10 bg-purple-500 rounded flex items-center justify-center text-white">
                                    ▶
                                </div>
...
const { conversationName, isGroup, getRecipient } = useConversation()
const currentView = ref<'info' | 'commonGroup'>('info')
