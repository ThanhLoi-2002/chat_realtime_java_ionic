import { IResponse, MessageFilter, SendMessageType, ShareMessagesType, ShareMessageType } from "@/types/common";
...
const shareMessages = async (data: ShareMessagesType) => {
    return await axios.post<IResponse<MessageType>>(`/conversations/id/messages/share-multi-messages`, data);
}
