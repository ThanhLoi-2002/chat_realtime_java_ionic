...
import com.zalo.modules.app.message.dto.response.MessageReactionResponse;
...
public class WebsocketService {
    ...
    public void saveSetting(Long conversationId, GroupSetting setting) {
        Map<String, Object> payload = new HashMap<>();
    ...
    public void newJoinGroupRequest(JoinGroupRequestResponse joinGroupRequest) {
        Map<String, Object> payload = new HashMap<>();
