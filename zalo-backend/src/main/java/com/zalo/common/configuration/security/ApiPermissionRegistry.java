...
//                String[] requiredPermissions = annotation.value(); // Lấy ra chuỗi quyền, VD: "user:delete"
//
...
//                        registry.put(new ApiConfig(httpMethod, pattern), requiredPermissions);
//                        System.out.println(G.toJson(registry));
//                    }
//                }
//            }
//        }
